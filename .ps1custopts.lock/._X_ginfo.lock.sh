...
export promptcmd='
	...
	PS1="$titleb\[\e[01;37m\][\[\e[01;34m\]${dirbase}\[\e[01;37m\]][\[\e[01;33m\]\${cfils}f \${cdirs}d\[\e[01;37m\]][\[\e[01;36m\]\$(date \"+%a %m/%d/%Y %H:%M\")\[\e[01;37m\]]\$(__git_ps1 \"[\[\e[01;35m\]%s \$(__git_ps1_show_sha)\[\e[01;37m\]]\")\n\[\e[01;37m\]\$(if [ -z \"\$SSH_IP\" ]; then echo \"LOCAL\"; else echo \$SSH_IP; fi;) -> \${TTY:5} \${statshow}\\\$ \[\e[00m\]";';
eval "$promptcmd";
